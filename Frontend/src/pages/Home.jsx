        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6">
              ...
              <Link to="/firms" className="bg-slate-900/50 backdrop-blur-sm hover:bg-slate-800 text-white border border-slate-700 hover:border-slate-500 px-8 py-4 rounded-lg font-semibold transition-all hover:-translate-y-1">
                View Top Firms
              </Link>
            </div>
          </motion.div>
            ...
            <nav className="flex flex-wrap justify-center gap-6 md:gap-8" aria-label="Social media links">
                {socials.map((social) => (
                    <a
                        ...
                        className={`group p-4 bg-slate-900 rounded-xl border border-slate-800 hover:border-slate-600 transition-all duration-300 hover:-translate-y-1 ${social.color} hover:bg-slate-800`}
                        title={social.name}
                    >
                        {social.icon}
