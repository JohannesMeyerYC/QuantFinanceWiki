    ...
    <div className="min-h-screen bg-slate-950 font-sans text-slate-200 selection:bg-emerald-500/30 selection:text-emerald-200 overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <nav className="flex flex-col sm:flex-row justify-center gap-4 sm:space-y-0 sm:space-x-6 px-4">
              <Link to="/roadmaps" className="bg-emerald-700 hover:bg-emerald-600 text-white px-8 py-4 rounded-lg font-semibold transition-all shadow-[0_0_25px_-5px_rgba(16,185,129,0.4)] hover:shadow-[0_0_35px_-5px_rgba(16,185,129,0.6)] active:scale-95 w-full sm:w-auto">
                Explore Roadmaps
              </Link>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-24">
        ...
        >
          ...
          <m.article variants={itemVariants} className="bg-slate-900/50 backdrop-blur-sm p-6 md:p-8 rounded-2xl border border-slate-800 hover:border-emerald-500/50 transition-all duration-300 group hover:bg-slate-900 hover:shadow-2xl hover:shadow-emerald-900/20 active:scale-[0.98]" role="listitem">
          ...
          <m.article variants={itemVariants} className="bg-slate-900/50 backdrop-blur-sm p-6 md:p-8 rounded-2xl border border-slate-800 hover:border-teal-500/50 transition-all duration-300 group hover:bg-slate-900 hover:shadow-2xl hover:shadow-teal-900/20 active:scale-[0.98]" role="listitem">
          ...
          <m.article variants={itemVariants} className="bg-slate-900/50 backdrop-blur-sm p-6 md:p-8 rounded-2xl border border-slate-800 hover:border-purple-500/50 transition-all duration-300 group hover:bg-slate-900 hover:shadow-2xl hover:shadow-purple-900/20 active:scale-[0.98]" role="listitem">
          ...
          <m.article variants={itemVariants} className="bg-slate-900/50 backdrop-blur-sm p-6 md:p-8 rounded-2xl border border-slate-800 hover:border-slate-600 transition-all duration-300 group hover:bg-slate-900 hover:shadow-2xl hover:shadow-slate-900/50 active:scale-[0.98]" role="listitem">
            ...
            <Link to="/faq" className="text-slate-300 hover:text-white font-medium inline-flex items-center group/link text-sm md:text-base" aria-label="Browse Frequently Asked Questions">
              Browse FAQ <span className="ml-2 group-hover/link:translate-x-1 transition-transform" aria-hidden="true">→</span>
                    ...
                    <m.article variants={itemVariants} className="bg-slate-900/50 backdrop-blur-sm p-6 md:p-8 rounded-2xl border border-slate-800 hover:border-blue-500/50 transition-all duration-300 group hover:bg-slate-900 hover:shadow-2xl hover:shadow-blue-900/20 active:scale-[0.98]" role="listitem">
